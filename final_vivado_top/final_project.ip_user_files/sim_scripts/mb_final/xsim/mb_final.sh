...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib blk_mem_gen_v8_4_5 dist_mem_gen_v8_0_13)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mb_final.wdb xsim.dir)
