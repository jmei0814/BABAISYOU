...
#
# Generated by Vivado on Fri Apr 19 09:23:33 -0500 2024
...
simulate()
{
  xsim  blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_final.protoinst" -log simulate.log
}
