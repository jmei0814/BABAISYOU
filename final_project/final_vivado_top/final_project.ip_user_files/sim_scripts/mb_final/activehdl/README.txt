...
#
# Generated by export_simulation on Tue Apr 30 14:03:16 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './mb_final.sh' script.

./mb_final.sh -reset_run
...
./mb_final.sh -noclean_files

For more information on the script, please type './mb_final.sh -help'.
